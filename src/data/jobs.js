const jobs = [
  ...
  },
  {
    ...
    description:
      "Sri Lanka Telecom  is  in  search  of  high  caliber, result-oriented  and  qualified  individuals...",
    requirements: [
  ...
  },
  {
    title: "ENGINEERS",
    description:
      "As an Engineer of the Engineering ICT Solutions Provider, you will be analyzing the requirements...",
    requirements: [
      "Four year Degree in BSc Engineering (Electrical or Electronic, Telecommunication, IT)...",
      "Thorough knowledge of the latest ICT developments...",
    ],
  },
  {
    title: "TECHNICIANS",
    description:
      "Technicians are mainly responsible to install, maintain and repair electronic communication equipment...",
    requirements: [
